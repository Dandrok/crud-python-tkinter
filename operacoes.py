...
class Usuarios(object):
    def __init__(self, idusuario=0, p_nome="", p_idade="", p_cpf="", p_email="", p_fone="", p_cidade="", p_uf="",
                 p_criado_em=""):
        self.info = {}
        self.idusuario = idusuario
        self.p_nome = p_nome
        self.p_idade = p_idade
        self.p_cpf = p_cpf
    ...
    def insert_user(self):
        ...
        try:
            ...
            c.execute(
                " INSERT INTO usuarios (nome, idade, cpf, email, fone, cidade, uf, criado_em) VALUES ('" + self.p_nome + "','" + self.p_idade + "','" + self.p_cpf + "','" + self.p_email + "','" + self.p_fone + "', '" + self.p_cidade + "', '" + self.p_uf + "', '" + self.p_criado_em + "' )")
    ...
    def update_user(self, idusuario):
        ...
        try:
            ...
            c.execute(
                " update usuarios set nome = '" + self.p_nome + "', idade = '"
                + self.p_idade + "', cpf = '" + self.p_cpf + "', email = '" + self.p_email + "', fone = '"
